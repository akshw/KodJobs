...
export function AIMatchingSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "AI Matching",
      description:
        "Advanced algorithms match you with the perfect opportunities",
    },
    {
      icon: <Mail className="h-10 w-10 text-yellow-500" />,
      title: "Personalized Emails",
      description:
        "Receive tailored job recommendations directly to your inbox",
    },
    {
  ...
  return (
    <section className="w-full py-12 md:py-16 bg-gradient-to-b from-white to-muted/30 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-white to-transparent"></div>

      {/* Move background elements up by adjusting their positioning */}
      <div className="absolute -left-20 top-20 w-40 h-40 bg-yellow-200 rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
      <div className="absolute -right-20 bottom-20 w-40 h-40 bg-blue-200 rounded-full filter blur-3xl opacity-20 animate-float"></div>

      {/* Adjust particle positions to be more visible initially */}
      <div className="absolute left-1/4 top-1/4 w-6 h-6 bg-yellow-400 rounded-full filter blur-sm opacity-30 animate-float"></div>
      <div className="absolute right-1/4 top-1/2 w-4 h-4 bg-yellow-300 rounded-full filter blur-sm opacity-20 animate-float-delayed"></div>
      <div className="absolute left-1/3 bottom-1/3 w-5 h-5 bg-blue-300 rounded-full filter blur-sm opacity-20 animate-float-reverse"></div>

      {/* Adjust sparkle positions */}
      <div className="absolute left-1/5 top-1/5">
        <Sparkles className="h-6 w-6 text-yellow-400 opacity-60 animate-pulse" />
      </div>
      <div className="absolute right-1/5 top-1/2">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          {/* <div className="space-y-0 max-w-3xl">
            <h2 className="text-2xl font-bold tracking-tighter md:text-2xl/tight animate-fade-in">
        ...
        <div className="mt-4 grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex items-center justify-center animate-slide-in-right">
            <Card
              className={cn(
                "w-full max-w-lg overflow-hidden border-2 border-yellow-100 shadow-lg",
                getAnimationClass()
              )}
            >
                ...
                >
                  ...
                  {activeStep === 0 && (
                    <div className="space-y-4">
                      <div className="h-40 border-2 border-dashed rounded-lg flex items-center justify-center bg-muted/30 relative overflow-hidden group">
                  ...
                  {activeStep === 1 && (
                    <div className="space-y-4">
                      <div className="h-40 rounded-lg bg-muted/30 flex items-center justify-center overflow-hidden relative">
                      ...
                      <div className="w-full bg-muted/30 rounded-full h-2 overflow-hidden">
                        <div
                          className="bg-yellow-500 h-2 rounded-full animate-progress"
                          style={{ width: "68%" }}
                        ></div>
                      </div>
                    </div>
                  ...
                  {activeStep === 2 && (
                    <div className="space-y-4">
                      <div className="h-40 rounded-lg bg-muted/10 border p-4 flex flex-col">
                  ...
                  {activeStep === 3 && (
                    <div className="space-y-4">
                      <div className="h-40 rounded-lg bg-muted/10 border p-4 overflow-y-auto">
