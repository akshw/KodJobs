...
import { BrainCircuit, Mail, Briefcase, ArrowRight, Loader2, Search, Filter, Users } from "lucide-react"
  ...
  const steps = [
    {
      ...
      title: "Post Your Job",
      description: "Describe your requirements, skills needed, and company culture",
    },
    {
      icon: <BrainCircuit className="h-10 w-10 text-yellow-500" />,
      title: "AI Matching",
      description: "Our algorithm finds candidates that match your specific needs",
    },
    {
    ...
    },
    {
      ...
      title: "Connect & Hire",
      description: "Contact candidates directly and streamline your hiring process",
    },
  ]
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <div className="space-y-2 max-w-3xl">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Find the Perfect Candidates</h2>
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed">
              Our AI matching technology helps you find qualified candidates that fit your specific requirements.
            </p>
          </div>
        </div>
              ...
              <CardContent className="p-6">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="icon" className="rounded-full" onClick={handleNextStep}>
                    ...
                    <div className="space-y-4">
                      <div className="h-32 border-2 border-dashed rounded-lg flex items-center justify-center bg-muted/30">
                        <div className="text-center">
                          ...
                          <p className="text-sm font-medium">Create a job posting</p>
                          <p className="text-xs text-muted-foreground">Describe your ideal candidate</p>
                        </div>
                      </div>
                      <Button className="w-full bg-yellow-500 hover:bg-yellow-600 text-black">Post a Job</Button>
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      <div className="h-32 rounded-lg bg-muted/30 flex items-center justify-center overflow-hidden relative">
                        ...
                        <div className="relative z-10 text-center">
                          ...
                          <p className="text-sm font-medium">Matching candidates</p>
                          <p className="text-xs text-muted-foreground">Finding the best talent for your needs</p>
                        </div>
                      </div>
                      ...
                      <div className="w-full bg-muted/30 rounded-full h-2">
                        <div className="bg-yellow-500 h-2 rounded-full animate-pulse" style={{ width: "78%" }}></div>
                      </div>
                    </div>
                  )}
                      ...
                      <div className="h-32 rounded-lg bg-muted/10 border p-3 overflow-y-auto">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between border-b pb-2">
                            ...
                            <Badge className="bg-yellow-100 text-yellow-800 hover:bg-yellow-100">87% Match</Badge>
                          </div>
                          <div className="flex items-center justify-between">
                            <div>
                            ...
                            <Badge className="bg-yellow-100 text-yellow-800 hover:bg-yellow-100">82% Match</Badge>
                          </div>
                        </div>
                      </div>
                  ...
                  {activeStep === 3 && (
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between border-b pb-2">
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                <p className="text-sm font-medium">Sarah Johnson</p>
                                <p className="text-xs text-muted-foreground">Available for interview</p>
                              </div>
                            </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                <p className="text-sm font-medium">Michael Chen</p>
                                <p className="text-xs text-muted-foreground">Reviewing your offer</p>
                              </div>
                            </div>
                            <Button variant="outline" size="sm" className="h-8">
                              Message
                      ...
                      <Button className="w-full bg-yellow-500 hover:bg-yellow-600 text-black">Manage Candidates</Button>
                    </div>
                  )}
                </div>
              </CardContent>
