...
export default function RequirementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setRequirement("");
      // Fetch updated matches after submitting requirements
      await fetchMatches();
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8">
            <Button
              variant="outline"
              size="sm"
              className="group overflow-hidden relative mb-6"
                    ...
                    <div className="flex justify-between items-start">
                      <div className="space-y-3 flex-grow">
                        ...
                        <div className="mt-4 flex space-x-3">
                          <a
                            href={
                              match.user.resumeUrl ||
                              "https://example.com/sample-resume.pdf"
                            }
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 transition-colors inline-flex items-center"
                          >
                            {match.user.resumeUrl
                              ? "View Resume"
                              : "View Sample Resume"}
